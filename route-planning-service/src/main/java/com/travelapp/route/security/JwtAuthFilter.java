...
import com.travelapp.route.client.AuthClient;
import com.travelapp.route.model.dto.InternalUserResponse;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            log.warn("Auth filter failed for {} {}: {}", request.getMethod(), request.getRequestURI(), e.getMessage());
